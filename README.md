...
A collection of group case assignments completed for Marketing Analytics (MBA 565), applying data driven approaches to business problems across a few different industries: hospitality (Airbnb), professional sports (Portland Trail Blazers ticketing), digital advertising (Rocket Fuel), and consumer packaged goods (U.S. beer market).
